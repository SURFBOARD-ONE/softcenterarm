...
def work_parent():
    ignore_paths = frozenset(["maintain_files", "softcenter", "rules", "v2ray_binary", "transmission", "speedup", "speedtest", "ddnsto", "bxc", "bypasshelper", "uu", "shadowsocks", "v2ray", "ssserver"])
